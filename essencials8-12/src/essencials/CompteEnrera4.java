...
public class CompteEnrera4  extends Thread {
	
	int cont;
	public String Nom;
	public Thread th;
	public CompteEnrera4 (String ID, int cuenta){
		super(ID);
		cont = cuenta;
		Nom = ID;
	...
	public void  run(){
		try{
			...
			Thread.sleep(998);
			System.out.println(i + " " + Nom + " ultima escriptura " + Exercici10.ultimaEscriptura);
			if(i == 0){
